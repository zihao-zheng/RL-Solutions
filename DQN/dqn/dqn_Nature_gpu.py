...
for i_episode in range(num_episodes):
    ...
    if i_episode % TARGET_UPDATE == 0:
        target_net.load_state_dict(policy_net.state_dict())
        torch.save(policy_net.state_dict(), '/Users/zhangqilin/Desktop/RL-Solutions/DQN/dqn/weights/policy_net_weights_{0}.pth'.format(i_episode))


print('Complete')
env.close()
torch.save(policy_net.state_dict(), '/Users/zhangqilin/Desktop/RL-Solutions/DQN/dqn/weights/policy_net_weights.pth')
