...
class DQN(nn.Module):
    ...
    def forward(self, x):
        ...
        x = F.relu(self.bn1(self.conv1(x))) #[32,32,20,20]
        x = F.relu(self.bn2(self.conv2(x))) #[32,64,9,9]
        x = F.relu(self.bn3(self.conv3(x))) #[32,64,7,7]
...
policy_net.load_state_dict(torch.load('/Users/zhangqilin/Desktop/RL-Solutions/DQN/dqn/weights/policy_net_weights.pth', map_location=torch.device('cpu')))
